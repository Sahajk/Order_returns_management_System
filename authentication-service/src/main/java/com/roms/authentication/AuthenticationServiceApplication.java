...
public class AuthenticationServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		userRepository.save(new User("sahaj", passwordEncoder.encode("khatri"), "ROLE_USER"));
		userRepository.save(new User("deepansh", passwordEncoder.encode("garg"), "ROLE_USER"));
		userRepository.save(new User("sakshi", passwordEncoder.encode("bhat"), "ROLE_USER"));
		userRepository.save(new User("hulk", passwordEncoder.encode("beast"), "ROLE_USER"));
	}
}
